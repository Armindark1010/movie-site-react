  ...
  return (
    <div className='flex justify-center border-none fixed z-50 top-0 left-0 right-0'>
      ...
      <div className="flex items-center justify-between md:w-1/3 w-10/12 relative">
        ...
        <div className='w-16 h-16 border relative border-none overflow-hidden -z-10 shadow-[0px_0px_800px_130px_#520000]'>
          ...
          <div className='shadow-[0px_0px_800px_155px_#520000] z-0'></div>
        </div>
        <div>
        ...
        <div>
          <Link to="/Kids" className={`font-bold text-2xl ${getLinkClass('/Kids')}`}>
            Kids
          </Link>
        </div>
      </div>
