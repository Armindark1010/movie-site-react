...
export const ModalComponent = () => {
  return (
    <div
      data-twe-modal-init
      className="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none backdrop-blur-[30px]"
      id="exampleModal"
      tabIndex="-1"
      ...
      <div
        ...
        className="pointer-events-none relative w-11/12 h-[90%] mx-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7">
        <div
          className="pointer-events-auto text-red-500 relative flex h-full flex-col w-full rounded-md border-none bg-white/20 backdrop-blur-[50px] bg-clip-padding text-current shadow-4 outline-none dark:bg-surface-dark">
          ...
          <div className="relative flex-auto h-5/6 flex justify-center items-center" data-twe-modal-body-ref>
