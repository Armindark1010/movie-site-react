...
https://api.themoviedb.org/3/person/${id}/images?api_key=fca43d4c1dc3416dd0309cde841c540a`
      ...
      if (film_id) {
        ...
        console.log(trailerResponse.data.results);
          ...
          <div className="md:flex h-[50%]">
            <div className="md:w-[80%] flex">
              <div className="md:w-[20%] w-[40%] rounded-md overflow-hidden">
                <Imgbox url={`https://image.tmdb.org/t/p/w500${personDetail.profile_path}`} />
            </div>
                ...
                <div>
                  <div>
                    <svg
                      ...
                      width="24"
                      height="24"
                      class="ipc-icon ipc-icon--video-library ipc-icon--inline sc-e27b52c0-0 jtHZUv"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      role="presentation"
                    >
                ...
                <div>
                  <div>
                    <svg
                      ...
                      width="24"
                      height="24"
                      class="ipc-icon ipc-icon--collections ipc-icon--inline sc-e27b52c0-0 jtHZUv"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      role="presentation"
                    >
